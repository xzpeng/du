...
<div id="contents">
	...
	<div class="right">
	   <ul id="TabPage1">
			...
			<li id="Tab3" onClick="javascript:switchTab('TabPage1','Tab3');"><span id="dnow99" style="display:block; font-size:12px; font-weight:normal;">空白</span></li>
	   </ul>
		<div id="cnt">
		  ...
		  <iframe src="#" name="content1" frameborder="0" scrolling="auto"></iframe>
			...
			<iframe src="iFrame" name="content3" id="content3" frameborder="0" scrolling="auto"></iframe>
			</div>
		</div>
	</div>
	<div class="clear"></div>
