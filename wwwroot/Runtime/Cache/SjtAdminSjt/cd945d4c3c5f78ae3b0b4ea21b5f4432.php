...
<div id="tongdao">
    ...
    <?php switch($_GET['apiname']): case "baofu": ?>宝付<?php break;?>
    ...
    <?php case "yipiaoliang": ?>易票联<?php break;?>
    <?php case "tengfutong": ?>腾付通<?php break; endswitch;?>
    </div>
    ...
    <div style="text-align:center; width:600px;"><input type="submit" value="确认修改"  style="font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="重 置"  style="font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="银行编码" onclick="javascript:location.href='/SjtAdminSjt_Tongdao_bankpay_apiname_<?php echo ($_GET['apiname']); ?>.html'" style="font-size:15px;" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="游戏点卡编码"  style="font-size:15px;" onclick="javascript:location.href='/SjtAdminSjt_Tongdao_gamepay_apiname_<?php echo ($_GET['apiname']); ?>.html'">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="上家费率" style="font-size:15px;" onclick="javascript:location.href='/SjtAdminSjt_Tongdao_sjfl_apiname_<?php echo ($_GET['apiname']); ?>.html'"></div><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
</form>
</body>
</html>