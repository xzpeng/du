...
<base target="_self" />
<body>
<form name="Form1" method="post" action="/SjtAdminSjt_ShangHu_czfledit.html">
<div style="width:100%; margin:0px auto; margin-top:10px; text-align:center; height:auto; font-size:20px; font-weight:bold;">【<span style="color:#03F"><?php echo ($UserName); ?></span>】单独设置充值手续费<br><br>
<div style="color:#F00; font-size:12px; font-weight:normal;">注：以下输入均为小于1的数字,请在小数点前加上0,比如网银99%的价格，请输入0.99&nbsp;&nbsp;<span style="color:#06C">如果为0，表示应用系统统一设置的费率！</span></div>
</div>
...
<div>电信短信：<input type="text" name="dxdx" value="<?php echo ($vo["dxdx"]); ?>"></div>    
<div>平台转账：<input type="text" name="nbzz" value="<?php echo ($vo["nbzz"]); ?>"></div><?php endforeach; endif; else: echo "" ;endif; ?>
</td>
</tr>
</table>
