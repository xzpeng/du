			...
			<div id="wrapper"><!-- Navigation -->
				...
				<div id="page-wrapper">
					...
					<div class="panel panel-default">
						<div class="panel-heading">信付云计费公告</div>
						<div class="panel-body">
							<div class="list-group">
				
								     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a  href="/User_Index_sjtggshow_newsid_<?php echo ($vo["id"]); ?>.html"
						...
						<div class="panel-footer">   <?php echo ($page); ?></div>
					</div>
				</div>
			</div>
