...
<title>信付云计费-为站长和开发者提供聚合多种支付通道du.local</title>
  ...
  <a href="/index.html"><img src="static/picture/logo.png" alt="首页"class="img-responsive" />
        ...
        <nav class="menu">
          <ul class="list-inline">
            ...
            <li><a>关于</a></li>
            <li><a>联系</a></li>
            <li><a href="http://du.local/index_login.html">进入商户平台</a></li>
          </ul>
        </nav>
         <div class="hotline">
         </div> 
        ...
        <div class="swiper-container items">
           <div class="swiper-wrapper">
                 <div class="swiper-slide">
                    <a href="http://du.local/index_login.html">
                    <img src="static/picture/11.jpg" alt="" href="http://du.local/index_login.html"/>
                    <p><strong>支付通道代开</strong><br />让您省去繁琐步骤，一次申请通过</p></a>
                  </div>
<div class="swiper-slide">
                    <a href="http://du.local/index_login.html">
                    <img src="static/picture/22.jpg" alt="" href="http://du.local/index_login.html"/>
