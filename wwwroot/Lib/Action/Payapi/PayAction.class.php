...
//              print_r($_GET);
			 ...
			 if($this->_request("PayBank")==2){
			 $zfid=1;
			 }elseif($this->_request("PayBank")==21){
			 $zfid=12;
			 }else{
			 $zfid=$this->_request("PayBank");
			 } 
      ...
      $hmac = MD5($hmacstr);
        ///////////////////////////////////////////////////////////////////
               ...
               $this->Sjt_Return_url = $p8_Url;      //商户底层（后台）通知地址
              //$this->Sjt_Return_url = $this->Sjt_Merchant_url;
         ...
         protected function Orderadd(){   //添加订单
           ...
           $this->Username = urldecode($this->_request("Sjt_UserName"));
             ...
             $jinfl = $sjapi->where("id=".$zfid)->getField("fl");
              $jiaoyijine = $this->OrderMoney * $jinfl;
		  ...
		  case "wxdemo":
             ...
             if($this->PayName=='Alipay' || $this->PayName=='WftWxWap' || $this->PayName=='WftWx' || strtolower($this->PayName)=='qqbao' ||  strtolower($this->PayName)=='wxdemo'){
				 
				 
                 $data['bankname']=$data['tongdao'];
             }
			 
			 if( strtolower($this->PayName)=='qqbao' ||  strtolower($this->PayName)=='wxdemo'){
